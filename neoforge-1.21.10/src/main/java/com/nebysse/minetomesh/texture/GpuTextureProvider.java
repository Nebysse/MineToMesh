...
public final class GpuTextureProvider implements TextureProvider {
    ...
    public GpuTextureProvider(GpuTextureAccess textureAccess) {
        // 1.21.10 起 AbstractTexture 不再暴露 GL id，从 blaze3d 的 GpuTexture 桥接回 GlTexture。
        this(textureAccess, texture ->
                texture.getTexture() instanceof GlTexture glTexture ? glTexture.glId() : 0,
