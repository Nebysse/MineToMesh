...
public final class ResourceTextureExtractor {
    ...
    public Extraction extractResource(Identifier textureId, ResourceManager resourceManager) throws IOException {
        Identifier pngId = pngResource(textureId);
    ...
    public Extraction extractDynamic(Identifier textureId, DynamicTexture texture) {
    ...
    public static Extraction failed(Identifier textureId, String message) {
        TextureKey key = new TextureKey(
                TextureKey.Kind.DYNAMIC,
                "minetomesh:missing_texture",
    ...
    private static Identifier pngResource(Identifier textureId) {
    ...
    private static TextureKey keyForResource(Identifier textureId) {
        String path = textureId.getPath();
        if (path.startsWith("textures/")) {
